...
if (temperature >= 80 && rain == true) {
  ...
  console.log("Weare a rain-jacket, and maybe also take an umbrella")
} else if (rain == true && temperature < 60) {
  console.log("carry an umbrella and weare a warm jacket!")
} else if (rain == false && temperature >= 60 && temperature < 80) {
  console.log("not too hold, not too hot, just right for a long sleeve shirt!")
} else if (rain == false && temperature < 60) {
  console.log("you might want a jacket!")
} else if (rain == false && temperature >= 80) {
  console.log("it could be warm today!")
}
